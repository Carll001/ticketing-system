        ...
        >
            <div class="grid auto-rows-min gap-4 lg:grid-cols-3">
                <Card class="flex items-center justify-between p-6">
                    <div>
                        <p
                            class="flex text-center text-sm text-muted-foreground"
                        >
                            Total Users
                        </p>
                        <p
                            class="item-center flex justify-center text-3xl font-bold"
                        >
                            {{ props.totalUsers }}
                        </p>
                    </div>
                ...
                <Card class="flex items-center justify-between p-6">
                    <div class="text-center">
                        ...
                        <p class="text-3xl font-bold">{{ props.totalTasks }}</p>
                    </div>
                </Card>
            </div>
