...
<template>
  <Card>
    ...
    <CardContent>
        ...
        >
          ...
          <div class="space-y-4 pl-2">
            ...
            >
              ...
              >
                ...
                <div :class="[type === 'Checkbox' ? 'w-auto order-1' : 'w-full order-2']">
                  ...
                  <Input 
                    v-if="type === 'Input'" 
                    :id="String(field.id)"
                    v-model="form.response[field.id]"
                    :readonly="isReadonly"
                    :disabled="isDisabled"
                  ...
                  <div v-else-if="type === 'Checkbox'" class="flex items-center">
                    <Checkbox 
                      :id="String(field.id)"
                      :model-value="getCheckboxValue(field.id)"
              ...
              <div 
                v-if="field.responses && field.responses.length > 0 && type !== 'Checkbox'"
                class="text-[10px] text-zinc-600 pl-1"
              >
                Last updated: {{ new Date(field.responses[0].updated_at || field.responses[0].created_at).toLocaleString() }}
              </div>
            </div>
          </div>
        </div>
      ...
      <div 
        v-if="isReadonly && props.step.fields && props.step.fields.length > 0" 
      ...
      <div 
        v-if="isDisabled && props.step.fields && props.step.fields.length > 0" 
